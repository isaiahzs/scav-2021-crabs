...
public class PigCrabEntity extends AnimalEntity implements ItemSteerable, Saddleable {
    private static final TrackedData<Boolean> SADDLED;
    private static final TrackedData<Integer> BOOST_TIME;
    private static final Ingredient BREEDING_INGREDIENT;
    private final SaddledComponent saddledComponent;

    public PigCrabEntity(EntityType<? extends PigCrabEntity> entityType, World world) {
    ...
    public PigCrabEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
        return (PigCrabEntity) Testmod.CROINK.create(serverWorld);
    }
    ...
    static {
        SADDLED = DataTracker.registerData(PigCrabEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        BOOST_TIME = DataTracker.registerData(PigCrabEntity.class, TrackedDataHandlerRegistry.INTEGER);
        BREEDING_INGREDIENT = Ingredient.ofItems(new ItemConvertible[]{Items.CARROT, Items.POTATO, Items.BEETROOT});
    }

    public static DefaultAttributeContainer.Builder createPigCrabAttributes() {
