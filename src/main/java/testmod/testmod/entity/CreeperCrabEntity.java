...
public class CreeperCrabEntity extends CreeperEntity implements SkinOverlayOwner {
    ...
    public CreeperCrabEntity(EntityType<? extends CreeperEntity> entityType, World world) {
    ...
    protected void dropEquipment(DamageSource source, int lootingMultiplier, boolean allowDrops) {
        ...
        if (entity != this && entity instanceof CreeperCrabEntity) {
            CreeperCrabEntity creeperCrabEntity = (CreeperCrabEntity)entity;
            if (creeperCrabEntity.shouldDropHead()) {
                creeperCrabEntity.onHeadDropped();
    ...
    static {
        FUSE_SPEED = DataTracker.registerData(CreeperCrabEntity.class, TrackedDataHandlerRegistry.INTEGER);
        CHARGED = DataTracker.registerData(CreeperCrabEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        IGNITED = DataTracker.registerData(CreeperCrabEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
    }
}
