...
public class VillagerCrabEntity extends AnimalEntity implements ItemSteerable, Saddleable {
    private static final TrackedData<Boolean> SADDLED;
    private static final TrackedData<Integer> BOOST_TIME;
    private static final Ingredient BREEDING_INGREDIENT;
    private final SaddledComponent saddledComponent;

    public VillagerCrabEntity(EntityType<? extends VillagerCrabEntity> entityType, World world) {
    ...
    public VillagerCrabEntity createChild(ServerWorld serverWorld, PassiveEntity passiveEntity) {
        return (VillagerCrabEntity) Testmod.CRABBAGER.create(serverWorld);
    }
    ...
    static {
        SADDLED = DataTracker.registerData(VillagerCrabEntity.class, TrackedDataHandlerRegistry.BOOLEAN);
        BOOST_TIME = DataTracker.registerData(VillagerCrabEntity.class, TrackedDataHandlerRegistry.INTEGER);
        BREEDING_INGREDIENT = Ingredient.ofItems(new ItemConvertible[]{Items.CARROT, Items.POTATO, Items.BEETROOT});
    }

    public static DefaultAttributeContainer.Builder createVillagerCrabAttributes() {
